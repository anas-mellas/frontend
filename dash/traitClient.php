        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user-plus"></i> Client</h6>
<?php
      if (isset($_GET['etat'])) {
        if($_GET['etat']=="true"){
          echo '
...
?>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <?php 
                  if(isset($_GET['id'])){
                    echo '<form action="modifyClient.php?id='.$customerID.'" method="POST" id="formajout">';
                          
                  }else{
                    echo '<form action="addClient.php" method="POST" id="formajout">';
                  }
                ?>
